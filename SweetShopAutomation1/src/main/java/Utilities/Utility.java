...
public class Utility {
    ...
    public static void selectFromDropdown(By locator, String text, WebDriver driver) {
        org.openqa.selenium.support.ui.Select dropdown = new org.openqa.selenium.support.ui.Select(driver.findElement(locator));
